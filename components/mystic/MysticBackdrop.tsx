...
export function MysticBackdrop({ variant = "dense" }: MysticBackdropProps) {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden text-[var(--vellum-300)]">
      <div className="absolute inset-0 bg-[linear-gradient(rgba(232,217,168,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(232,217,168,0.035)_1px,transparent_1px)] bg-[size:96px_96px] opacity-25" />
      <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(232,217,168,0.5)_0_0.7px,transparent_1px)] bg-[size:34px_34px] opacity-20 [mask-image:linear-gradient(to_bottom,black,transparent_88%)]" />
